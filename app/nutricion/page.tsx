...
type NutricionPageProps = {
  searchParams: Promise<{ marca?: string; q?: string; sort?: string; page?: string }>
}
  ...
  return (
    <div className="page-shell">
      <section className="page-hero p-6 sm:p-8">
        <p className="tag-pill">Catalogo nutricion</p>
        <h1 className="mt-3 text-4xl font-bold text-slate-900">Nutricion especializada</h1>
        <p className="mt-2 max-w-3xl text-base leading-7 text-slate-600 sm:text-lg">
          Alimentos premium para perros y gatos por edad, marca y objetivo nutricional.
        </p>

        <div className="mt-6">
          <CatalogSearchBar placeholder="Buscar alimento o marca..." initialValue={params.q ?? ''} />
        </div>
      </section>
